...
class Unittest(unittest.TestCase):
    def test_basic(self):
        ...
        rd.rna_draw(
            ss="(....)", seq="CUUCGG", out="test_renders/test_2", color_str="1-6:r"
        )

        rd.rna_draw(
            ss="(....)", seq="CUUCGG", out="test_renders/test_3", render_type="res_type"
        )

        rd.rna_draw(
            ss="(....)", seq="CUUCGG", out="test_renders/test_4", default_color="g"
        )
